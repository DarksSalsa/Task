...
CREATE TABLE production.brands (
	brand_id INT GENERATED ALWAYS AS IDENTITY (START WITH 1  INCREMENT BY 1) PRIMARY KEY,
...
CREATE TABLE sales.staffs (
	staff_id INT GENERATED ALWAYS AS IDENTITY (START WITH 1  INCREMENT BY 1) PRIMARY KEY,
