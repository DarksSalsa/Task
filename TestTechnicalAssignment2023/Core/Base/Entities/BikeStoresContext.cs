...
public partial class BikeStoresContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E276F86333C");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B41E8B9EF3");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85069C4420");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__4659622989257AEA");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D46249CDDF");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5388B6064");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CCDD6ABE9");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E616436E3D9DF").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D387FCAA86");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C59EDE09F");
